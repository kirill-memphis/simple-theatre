    ...
    <body>
        ...
        <div id="main">
            ...
            <section>
                <article>
                    <table>
                    <tr>
                        <td><h1>Описание спектакля</h1></td>
                        <td><a href="/NewTheatre/login">[Авторизуйтесь]</a>или<a href="/NewTheatre/registration">[Зарегестрируйтесь]</a></td>
                    </tr>
                    </table>
        ...
        <footer>
            <div>
                ...
                <span><a target="_blanc" href="#">Главная страница</a></span>
            </div>
        </footer>
    </body>
</html>